...
const Navbar = () => {
  return (
    <nav className='flex items-center bg-slate-900 py-3 px-5'>
        ...
        <div className='px-5 text-2xl text-slate-50 hover:text-slate-400'><Link href='/'>Home</Link></div>
        <div className='px-5 text-2xl text-slate-50 hover:text-slate-400'><Link href='/Help'>Help</Link></div>
        </div>
        <div className=''>
